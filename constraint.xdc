...
set_property PACKAGE_PIN W5 [get_ports clk]							
	...
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_adc_sclk_new/O] 
...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {led_out21[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_out21[6]}]
set_property PACKAGE_PIN W6 [get_ports {led_out21[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_out21[5]}]
set_property PACKAGE_PIN U8 [get_ports {led_out21[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_out21[4]}]
set_property PACKAGE_PIN V8 [get_ports {led_out21[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_out21[3]}]
set_property PACKAGE_PIN U5 [get_ports {led_out21[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_out21[2]}]
set_property PACKAGE_PIN V5 [get_ports {led_out21[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_out21[1]}]
set_property PACKAGE_PIN U7 [get_ports {led_out21[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_out21[0]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports pc]						
